...
export MFMODULE=MFBASE
export MFMODULE_LOWERCASE=mfbase
...
echo "export MFMODULE_VERSION := ${MFBASE_VERSION}" >>adm/root.mk
...
echo "export ${MFMODULE}_VERSION := ${MFBASE_VERSION}" >>adm/root.mk
