...
latex_documents = [
    (master_doc, 'mfbase.tex',
     u'mfbase Documentation',
     u'MetWork', 'manual'),
]
...
man_pages = [
    (master_doc, 'mfbase', u'mfbase Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'mfbase', u'mfbase Documentation',
     author, 'mfbase', 'One line description of project.',
     'Miscellaneous'),
]
