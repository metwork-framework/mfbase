...
## How to install mfbase metwork module
...
### Optional mfbase layers

To list available (and not already installed) mfbase additional
layers, you can use the following command:

```console
# For CentOS or Fedora (see above note for other distributions)
yum list |grep 'metwork-mfbase-layer-.*:'
```
